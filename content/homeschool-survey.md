...
Memory scores are to th side, total screen time is on the bottom.
...
To save time, I won't even go into the data here.  Before I had even run the numbers much, it became totally apparent to me that this idea was wholly **UNSUPPORTED**.
...
Another thing that I found interesting from the dataset was the amount of people that answered the multiple choice eschatology question with "not sure", 69%.  83% if I count the minors that answered differently than their parents as "not sure" also.

Alright, Ive left the most mind-blowing discovery for last.  Once I would finish reciting words in the memory test to a person, I would ask them, "Do you want me to repeat the list?"  If they said yes, I would repeat it again and ask them if they want me to repeat it again.  I would repeat the list up to three times per individual.
...
I have certainly learned a lot of things from doing this survey.  I hope you have also learned a lot from what I have shared with you.  I don't know about you, but this survey has left me with a lot more questions than I had before, such as:

- "How much would a much larger amount of data change the current results?"  I only surveyed 31 people.  Statistically, that is not enough people to really represent a majority.
- "Some people claim that homeschoolers are often smarter the government schoolers.  Is this really true?"  Maybe we could do something like the memory test used in this survey, but probably we would need something a little more geared to brain power.

Well folks, goodbye for now 👋.  In the midst of a world of uncertainties, of one thing I can be certain (among others), no matter how interesting I thought homeschoolers were before, I believe they are a good deal more interesting now.
